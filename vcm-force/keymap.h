...
//
// keyboard/ 스케치는 여기서 세기 gain(중심 1.0 -> 엣지 0.1)을 만들어 클릭 진폭을
// 줄였다. 이 스케치는 진폭을 건드리지 않고 대신 버클링 임계힘을 올리므로,
// 곡선을 씌우지 않은 정규화 거리 자체를 그대로 넘긴다. 힘 곡선의 모양은
// vcm-force.ino의 F_EDGE_SCALE / F_EDGE_CURVE에서 정한다.
